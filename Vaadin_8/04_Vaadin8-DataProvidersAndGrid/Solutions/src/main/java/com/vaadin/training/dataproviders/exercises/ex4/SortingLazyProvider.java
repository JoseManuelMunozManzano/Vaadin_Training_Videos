package com.vaadin.training.dataproviders.exercises.ex4;
...
public class SortingLazyProvider extends VerticalLayout implements View {
	private static final long serialVersionUID = 1L;

	final PersonService service = new PersonService();

	public SortingLazyProvider() {
		...
		// Sorting parameter has been added
