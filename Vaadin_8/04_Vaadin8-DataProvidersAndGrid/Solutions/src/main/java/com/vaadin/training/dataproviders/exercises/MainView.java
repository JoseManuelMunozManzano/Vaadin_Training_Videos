...
import com.vaadin.training.dataproviders.exercises.ex4.SortingLazyProvider;
...
public class MainView extends VerticalLayout implements View {
	...
	public MainView(Navigator navigator) {
		...
		createExerciseLink(i++, "Sorting a BackEndDataProvider", SortingLazyProvider.class);
	}
